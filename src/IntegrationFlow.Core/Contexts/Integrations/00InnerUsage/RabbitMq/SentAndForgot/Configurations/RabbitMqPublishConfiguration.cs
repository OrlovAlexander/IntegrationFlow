...
namespace IntegrationFlow.Contexts.Integrations._00InnerUsage.RabbitMq.SentAndForgot.Configurations
{
    ...
    public class RabbitMqPublishConfiguration : IConfiguration, IRabbitMqConnectionConfiguration
    {
        ...
        /// <summary>
        /// AMQP priority (0–255). Не задано — свойство не выставляется явно.
        /// </summary>
        public byte? Priority { get; set; }

        /// <summary>
        /// TTL сообщения в миллисекундах (basic.properties.expiration). Не задано — свойство не выставляется.
        /// </summary>
