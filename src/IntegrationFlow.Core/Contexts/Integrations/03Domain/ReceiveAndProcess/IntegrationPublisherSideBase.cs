...
namespace IntegrationFlow.Contexts.Integrations._03Domain.ReceiveAndProcess
{
    internal abstract class IntegrationPublisherSideBase
    {
        ...
        public abstract IConfiguration GetConfiguration(PublisherBase publisher, IIntegrationLogger logger);
        ...
        /// <param name="logger">Логгер в рамках интеграций</param>
        public abstract ListenerBase GetListener(PublisherBase publisher, IConfiguration configuration, IIntegrationLogger logger);
        ...
        /// <param name="configuration">Конфигурация публикатора, слушателя</param>
        /// <param name="logger">Логгер в рамках интеграций</param>
        public abstract ProcessorBase GetProcessor(PublisherBase publisher, IConfiguration configuration, IIntegrationLogger logger);
    }
}
