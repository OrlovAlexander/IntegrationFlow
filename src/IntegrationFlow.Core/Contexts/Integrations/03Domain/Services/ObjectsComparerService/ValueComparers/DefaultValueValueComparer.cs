namespace IntegrationFlow.Contexts.Integrations._03Domain.Services.ObjectsComparerService.ValueComparers
{
    ...
    public class DefaultValueValueComparer<T> : IValueComparer
    {
        ...
        {
            var isObj1Default = obj1 != null ? obj1.Equals(_defaultValue) != false || obj1.Equals(_typeDefaultValue) : false;
            var isObj2Default = obj2 != null ? obj2.Equals(_defaultValue) != false || obj2.Equals(_typeDefaultValue) : false;
        ...
        public string ToString(object value)
        {
            ...
            if (value != null && value.Equals(_typeDefaultValue) != false)
            {
                return _valueComparer.ToString(_defaultValue);
            }
            return _valueComparer.ToString(value);
        }
    }
}
