...
namespace IntegrationFlow.Contexts.Integrations._03Domain.Services.ObjectsComparerService.Exceptions
{
    /// <summary>
    ...
    public class AmbiguousComparerOverrideResolutionException: Exception
    {
        ...
        internal AmbiguousComparerOverrideResolutionException(Type type)
            : base($"Unable to resolve comparer for type {type.FullName}. More than one value comparer meet criteria for this type.")
        {
            Type = type;
        }
    }
