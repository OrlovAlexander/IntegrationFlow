...
internal sealed class SqlServerRpcPendingClaimStrategy : IRpcPendingClaimStrategy
{
    internal const string TableName = "IntegrationFlowRpcPendingRequests";

    internal static readonly SqlServerRpcPendingClaimStrategy Instance = new();

    private SqlServerRpcPendingClaimStrategy()
    {
    }
