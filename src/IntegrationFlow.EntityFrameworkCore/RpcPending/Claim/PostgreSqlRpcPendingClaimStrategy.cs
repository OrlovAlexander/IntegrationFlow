...
internal sealed class PostgreSqlRpcPendingClaimStrategy : IRpcPendingClaimStrategy
{
    internal const string TableName = "IntegrationFlowRpcPendingRequests";

    internal static readonly PostgreSqlRpcPendingClaimStrategy Instance = new();

    private PostgreSqlRpcPendingClaimStrategy()
    {
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        AddParameter(command, "@status", (int)RpcPendingStatus.Pending);
