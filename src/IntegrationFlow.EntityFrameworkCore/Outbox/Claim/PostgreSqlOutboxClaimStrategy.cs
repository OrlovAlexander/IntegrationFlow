...
internal sealed class PostgreSqlOutboxClaimStrategy : IOutboxClaimStrategy
{
    internal const string TableName = "IntegrationFlowOutboxMessages";

    internal static readonly PostgreSqlOutboxClaimStrategy Instance = new();

    private PostgreSqlOutboxClaimStrategy()
    {
    }
