...
namespace IntegrationFlow.Contexts.Integrations._03Domain.Services.ObjectsComparerService.CustomComparers
{
    internal class TypesComparer : AbstractComparer, IComparerWithCondition
    {
        ...
        public override IEnumerable<Difference> CalculateDifferences(Type type, object obj1, object obj2)
        {
            ...
            if (obj1 != null && obj1.GetType().InheritsFrom(typeof(Type)) == false)
            {
                throw new ArgumentException(nameof(obj1));
            }

            if (obj2 != null && obj2.GetType().InheritsFrom(typeof(Type)) == false)
            {
                throw new ArgumentException(nameof(obj2));
            }

            var type1Str = obj1 != null ? obj1.ToString() : null;
            var type2Str = obj2 != null ? obj2.ToString() : null;
