...
{
    /// <summary>
    /// Implementation of <see cref="IntegrationExchange.Contexts.Integrations._03Domain.Services.ObjectsComparerService.IComparer{T}"/> which provides implementation of Compare methods.
    /// </summary>
    public abstract class AbstractComparer<T>: BaseComparer, Contexts.Integrations._03Domain.Services.ObjectsComparerService.IComparer<T>
    {
