...
using IntegrationFlow.Contexts.Integrations._03Domain.Services.ObjectsComparerService.Exceptions;
using IntegrationFlow.Contexts.Integrations._03Domain.Services.ObjectsComparerService.Utils;
using IntegrationFlow.Contexts.Integrations._03Domain.Services.ObjectsComparerService.ValueComparers;
...
namespace IntegrationFlow.Contexts.Integrations._03Domain.Services.ObjectsComparerService
{
    internal class ComparerOverridesCollection
    {
        ...
        public IValueComparer GetComparer(MemberInfo memberInfo)
        {
            ...
            IValueComparer memberFilterOverride = null;
            if (_overridesByMemberFilter.Find(t => t.Item1(memberInfo)) != null)
            {
                memberFilterOverride = _overridesByMemberFilter.Find(t => t.Item1(memberInfo)).Item2;
            }
