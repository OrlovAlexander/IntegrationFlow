...
namespace IntegrationFlow.Contexts.Integrations._03Domain.Services.ObjectsComparerService
{
    /// <summary>
    /// Compares objects.
    /// </summary>
    public class Comparer : AbstractComparer
    {
        private static string CalculateDifferencesMethodName
        {
            ...
            get { return MemberInfoExtensions.GetMethodName<Contexts.Integrations._03Domain.Services.ObjectsComparerService.Comparer<object>>(x => x.CalculateDifferences(null, null)); }
        }
        ...
        {
            var objectsComparerMethod = typeof(IComparersFactory).GetMethods().First(m => m.IsGenericMethod);
            ...
            var genericType = typeof(Contexts.Integrations._03Domain.Services.ObjectsComparerService.IComparer<>).MakeGenericType(type);
            var method = genericType.GetMethod(CalculateDifferencesMethodName, new[] { type, type });
