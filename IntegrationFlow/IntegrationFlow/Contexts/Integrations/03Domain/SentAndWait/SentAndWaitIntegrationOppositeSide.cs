...
namespace IntegrationFlow.Contexts.Integrations._03Domain.SentAndWait
{
    ...
    internal abstract class SentAndWaitIntegrationOppositeSide
    {
        ...
        public abstract IFormatterTransmitData GetFormatterSourceData(ILogger logger);

        /// <summary>
        /// Возвращает конфигуратор способа обращения к противоположной стороне
        /// </summary>
        /// <param name="logger">Логгер в рамках интеграций</param>
        public abstract IConfiguration GetTransmitterConfiguration(ILogger logger);
        ...
        /// <param name="logger">Логгер в рамках интеграций</param>
        public abstract IConnection GetConnection(IConfiguration configuration, ILogger logger);
        ...
        public abstract ITransmitter GetTransmitter(IConfiguration configuration, IConnection connection, ILogger logger);
        ...
        /// <param name="configuration">Конфигуратор способа обращения к противоположной стороне</param>
        /// <param name="logger">Логгер в рамках интеграций</param>
        public abstract IValidator GetValidator(IConfiguration configuration, ILogger logger);
        ...
        /// <param name="logger">Логгер в рамках интеграций</param>
        /// <returns>Форматировщик</returns>
        public abstract IFormatterObtainedData GetFormatterObtainedData(ILogger logger);

        /// <summary>
        /// Возвращает логгер данных
        /// </summary>
        /// <param name="logger">Логгер в рамках интеграций</param>
        public abstract ILogging GetLogging(ILogger logger);
