...
public sealed class EfOutboxSqlServerClaimTests : IAsyncLifetime
{
    ...
    [Fact]
    public async Task ClaimPendingAsync_ParallelWorkers_ClaimDistinctMessages_SqlServer()
    {
        ...
        await using var factory = await ProviderTestDbContextFactory.CreateSqlServerAsync(container);
